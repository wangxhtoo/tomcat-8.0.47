...
public final class Request {
	 ...
	 * request. In future this should be fixed, and sent only once ( or 'negotiated'
	 ...
	 * there is no value set. This is the "virtual host", derived from the Host:
	 * header.
	 */
	 ...
	 * have the req, getting/setting a note is just a array access, may be faster
	 * than ThreadLocal for very frequent operations.
	 *
	 * Example use: Jk: HandlerRequest.HOSTBUFFER = 10 CharChunk, buffer for Host
	 * decoding WorkerEnv: SSL_CERT_NOTE=16 - MessageBytes containing the cert
	 *
