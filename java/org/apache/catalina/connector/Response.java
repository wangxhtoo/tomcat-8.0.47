...
public class Response implements HttpServletResponse {
	...
	/**
	 * Return the number of bytes the application has actually written to the output
	 * stream. This excludes chunking, compression, etc. as well as headers.
	 */
	 ...
	 *
	 * Called from set/addHeader. Return true if the header is special, no need to
	 * set the header.
	 */
